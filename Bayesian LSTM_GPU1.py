...
df = pd.read_csv(r'C:\Users\NIU004\OneDrive - CSIRO\Desktop\Data_3_segment.csv')
...
training_df['data_value1'] = inverse_transform(training_predictions.detach().cpu().numpy())
...
testing_df['data_value1'] = inverse_transform(testing_predictions.detach().cpu().numpy())
